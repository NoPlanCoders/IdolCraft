...
public class ClientInputHandler {
    ...
    @Mod.EventBusSubscriber(modid = IdolCraft.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.FORGE)
    public static class ForgeEvents {
        ...
        public static void onClientTick(TickEvent.ClientTickEvent event) {
            ...
            while (KeyBindings.OPEN_DECK_EDITOR.consumeClick()) {
                ...
                if (mc.player != null) {
                    mc.setScreen(new com.idolcraft.client.gui.DeckEditorScreen());
                }
            }
            while (KeyBindings.OPEN_PLEVEL.consumeClick()) {
                Minecraft mc = Minecraft.getInstance();
                if (mc.player != null) {
                    mc.setScreen(new com.idolcraft.client.gui.PLevelScreen());
                }
            }
        }
